  ...
  return (
    <html lang="en" className="!scroll-smooth">
      ...
      bg-gray-50 text-gray-950 -z-10 relative pt-28 sm:36 dark:bg-gray-900 dark:text-gray-300 dark:text-opacity-90 dark:-z-20` }>
        <div className="bg-[#c9d9f2] absolute top-[-6rem] -z-10 right-[11rem] h-[31.25rem] w-[31.25rem] rounded-full blur-[20rem] sm:w-[68.75rem] dark:bg-[#323342] dark:-z-10"></div>
        <div className="bg-[#f6e4e4] absolute top-[-1rem] -z-10 left-[-35rem] h-[31.25rem] w-[50rem] rounded-full blur-[20rem] sm:w-[68.75rem] md:left-[-33rem] lg:left-[-28rem] xl:left-[-15rem] 2xl:left-[-5rem] dark:bg-[#453d3b] dark:-z-10"></div>
        <div 
